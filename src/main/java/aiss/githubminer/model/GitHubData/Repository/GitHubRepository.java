...
package aiss.githubminer.model.GitHubData.Repository;
...
public class GitHubRepository {
    ...
    public String toString() {
        ...
        sb.append(GitHubRepository.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
