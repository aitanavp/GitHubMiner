...
public class GitHubMilestone {
    ...
    @JsonProperty("creator")
    public GitHubCreator getCreator() {
        return creator;
    }

    @JsonProperty("creator")
    public void setCreator(GitHubCreator creator) {
    ...
    public String toString() {
        ...
        sb.append(GitHubMilestone.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("url");
        sb.append('=');
