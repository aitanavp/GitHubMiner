...
public class ProjectService {
    ...
    public Project getProjectByOwnerAndName(String owner, String repo, Integer sinceCommits, Integer sinceIssues, Integer sincePulls, Integer pages) {
        ...
        List<PullRequest> pulls = pullRequestService.sincePulls(owner, repo, sincePulls, pages);
        return GitHubMapper.toProject(response.getBody(), commits, issues, pulls);
    }
}
